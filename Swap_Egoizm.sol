...
contract EGOIZM is ERC20, Ownable {

    address public minter;

    event setNewMinter(address indexed owner, address indexed newMinter);

    constructor() ERC20("EGOIZMLIFE_Token", "EGOIZM") {
        minter = msg.sender;
    }
...
contract Swap_Egoizm is Ownable {
    ...
    function getEGOIZM(uint amountUSDT) public {
    ...
    function sellEGOIZM(uint amountUSDT) public {
